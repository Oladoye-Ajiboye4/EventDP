...
const TestimonialSection = () => {
  return (
    <section className="py-24 bg-forest-green/5 dark:bg-forest-green/10">
      <div className="max-w-4xl mx-auto px-4 text-center">
        {/* Quote Icon */}
        <svg className="w-12 h-12 text-forest-green/30 mb-6 mx-auto" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* Quote Text */}
        <p className="text-2xl md:text-3xl font-medium text-dark-slate dark:text-white mb-8 italic">
